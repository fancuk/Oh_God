...
import com.moonbanggoo.ohgod.Network.RestCoroutine.dettachObserver
import com.moonbanggoo.ohgod.Network.RestCoroutine.getWeather
...
class SelectLocationActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       this.jeju  =     findViewById<Button>(R.id.JejuButton)
        ...
        this.gangwon   .setOnClickListener          {setLocation(this.gangwon   .text.toString()); getWeather(); finish()}
        this.jeju       .setOnClickListener         {setLocation(this.jeju   .text.toString()); getWeather(); finish()}
    }
